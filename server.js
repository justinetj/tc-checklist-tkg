...
const BUYER_ITEMS = [
  ...
  { id: "b46",  label: "Update FUB status" },
  { id: "b46b", label: "Change status to closed", indent: true },
  { id: "b46c", label: "Reconfirm sales price", indent: true },
  { id: "b46a", label: "Reconfirm closing date", indent: true },
